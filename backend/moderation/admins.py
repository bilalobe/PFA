...
class ModerationAdmin(admin.ModelAdmin):
    list_display = (
        'post_link', 'reason', 'reported_by', 'created_at', 'moderator', 'action_taken', 'action_taken_at'
    )
    ...
    def take_action(self, request, queryset):
        ...
        if 'apply' in request.POST:
            ...
            return redirect('admin:forum_moderation_changelist')  # Redirect to the moderation list
