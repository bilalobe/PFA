...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = (
            'id', 'title', 'description', 'instructor', 'created_at', 'average_rating',
        )
...
class ModuleDetailSerializer(serializers.ModelSerializer):
    ...
    resources = ResourceSerializer(many=True, read_only=True)  # Include related resources
...
class ReviewCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {'course': {'write_only': True}} # Course is provided in the context
