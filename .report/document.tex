...
\subsection{ Prototype de la Page d'Accueil GUI}
...
\subsection{ Portions de Languages de programmation Utilisés}
...
\subsection{ Comparatif aux normes de communauté}
...
\subsection{ Contributions journalières intrinsèques}
...
\subsection{Contributions au Graphique Principal à travers les Commits GitHub}
...
\subsection{ Pull Requests Fusionnées par Jour}
...
\subsection{ Taux de Git Clones mensuels}
...
% Include Gantt chart
\input{misc/gantt/gantt.tex}

% Include PERT chart
\input{misc/pert/pert.tex}
