...
\begin{environnement}[breakable][title=Structure du Rapport]
...
\smallbreak Nous voulons être certain que toute tranche d'âge puisse proactivement contribuer dans le boulon de l'apprentissage en ligne à travers notre plateforme.
...
\begin{itemize}[leftmargin=*,label=\textbullet,font=\color{violet}]
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[node distance=2cm, auto]
            ...
            % Nodes
            \node [block] (adapt) {Adaptable Interface};
            \node [block, right=of adapt] (feedback) {Real-time Feedback};
            \node [block, below=of $(adapt)!0.5!(feedback)$] (personal) {Personalized Experience};
...
\textit{Pour plus d'informations sur nos projets et notre vision, visitez notre site web: \href{http://www.pfa-education.com}{_en cours de construction_}.} 
\vfill
